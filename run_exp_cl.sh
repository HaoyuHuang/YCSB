...
base_dir="/proj/BG/yaz/ycsbcache/YCSB/redis/resources"
...
#    exit -1
    ...
    cmd="bash /proj/BG/yaz/ycsbcache/YCSB/run_ycsb.sh $db $wl $numrecs $dur $totalthreads $redis_caches_ports $db_machine $numar $arSleep $metricsFile $dbfail $alpha $cachemode $tardismode $ewstats"
